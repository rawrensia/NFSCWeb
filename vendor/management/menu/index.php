...
<body>
	...
	<div class="container">
		<?php
		if(isset($_SESSION["item_added_to_menu"]) && $_SESSION["item_added_to_menu"] == "1") {
			echo "<p id=\"notification\" class=\"message_okay\">Item added to menu successfully!</p>";
			unset($_SESSION['item_added_to_menu']);
		}
		else if (isset($_SESSION["item_edited"]) && $_SESSION["item_edited"] == "1") {
			echo "<p id=\"notification\" class=\"message_okay\">Item Updated successfully!</p>";
			unset($_SESSION['item_edited']);
		}
		?>
		<script>
		  setTimeout(function(){
		...
		<div class="wrapper">
			<div>
				...
				<nav class="mainnav">
					<?php
						include "../../nav/subnav-management-menu-list.php";
					?>
					&nbsp;
				</nav>
				<?php include "queries/getmenulist.php"; ?>
				<?php
				...
				while($row=$result->fetch_row()) {
					...
					$href = "editmenuitem.php?id=" . $itemid;
				?>
				<div class="cleanlink">
